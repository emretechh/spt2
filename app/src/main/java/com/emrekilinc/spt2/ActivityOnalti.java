...
public class ActivityOnalti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onalti);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (parent.getSelectedItem().toString().equals("Su birim ağırlığı (γw) (kg / m³)"))
                    textView6.setText("Batık birim hacim ağırlığı (γb) (Kg /  m³)");

                else if (parent.getSelectedItem().toString().equals("Su birim ağırlığı (γw) (N / m³)"))
                    textView6.setText("Batık birim hacim ağırlığı (γb) (N / m³)");

                else if (parent.getSelectedItem().toString().equals("Su birim ağırlığı (γw) (Ib / ft³)"))
                    textView6.setText("Batık birim hacim ağırlığı (γb) (Ib / ft³)");
        ...
        getSupportActionBar().setTitle("Batık Birim Hacim Ağırlığı");
    }
